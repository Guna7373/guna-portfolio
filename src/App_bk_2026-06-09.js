...
const style = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  :root {
    --bg: #060b17; /* Dark navy page background */
    --surface: rgba(10, 19, 37, 0.88); /* Deep glass surface */
    --surface-solid: #07111f;
    --surface2: rgba(10, 16, 33, 0.9);
    --accent: #38bdf8; /* Bright cyan accent */
    --accent2: #7c3aed; /* Violet accent */
    --accent3: #60a5fa; /* Softer blue accent */
    --text: #f8fafc; /* Light text */
    --muted: #94a3b8; /* Muted cool text */
    --border: rgba(148, 163, 184, 0.16); /* Subtle bright border */
    --glow: rgba(56, 189, 248, 0.14);
  }
  
  body {
    background: radial-gradient(circle at top left, rgba(56, 189, 248, 0.12), transparent 18%),
      radial-gradient(circle at bottom right, rgba(124, 58, 237, 0.14), transparent 18%),
      linear-gradient(180deg, #040711 0%, #081422 42%, #061122 100%);
    color: var(--text);
    ...
    <>
      ...
      <div className="portfolio-root">
        ...
        <div className="nav-wrapper">
          <nav className="nav">
            <div className="nav-logo">&lt;Web Dev&gt;</div>
